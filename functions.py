...
# You can return the formatted_date from here
...
def terminalbot():
    ...
    system_prompt = rd.get("seiji@trainual.com-systemprompt-01").decode('utf-8')
    initial_text = rd.get("seiji@trainual.com-initialtext-01").decode('utf-8')
